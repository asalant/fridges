...
Devise.setup do |config|
  ...
  config.pepper                     = "2f9965ccc5c9a7c11761d09abd68746ce7bf867a774df72b5cefa28cb4458bfd56706a09b0ba0e30c59a51557e5fbaa602d61f36d55e36cae427d9f94da39e0e"
  ...
  module Facebook
    CONFIG = YAML.load(ERB.new(File.read(Rails.root.join('config', 'facebook.yml'))).result)[Rails.env]
    APP_ID = CONFIG['app_id']
    SECRET = CONFIG['secret_key']
  end

  config.oauth :facebook, Facebook::APP_ID, Facebook::SECRET,

...
describe WebhooksController do
  ...
  describe "POST sendgrid" do
    before do
      Fridge.should_receive(:create!)
      params = {
        "from"=>"alon@salant.org", "to"=>"upload@frdg.us\n", "dkim"=>"none",
        "subject"=>"Another try\n", "text"=>"How about this time?\r\n\n",
        "attachment1"=> File.new('spec/fixtures/fridge.jpg'), "attachment2"=>File.new('spec/fixtures/fridge.jpg'), "SPF"=>"none", "attachments"=>"2",
